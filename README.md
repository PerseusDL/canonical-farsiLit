[![Hook Status](http://ci.perseids.org/Hook/api/rest/v1.0/code/PerseusDL/canonical-farsiLit/master/badge/status.svg)](http://ci.perseids.org/Hook/repo/PerseusDL/canonical-farsiLit)
